...
Java_com_singularity_1code_core_network_util_SecuredDev_getBaseUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF("https://jsonplaceholder.typicode.com/");
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_singularity_1code_core_network_util_SecuredDev_getBasePokemonUrl(JNIEnv *env, jobject thiz) {
